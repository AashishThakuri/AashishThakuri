...
def render_readme(garden, source):
  ...
  <img src="./assets/ascii-terminal-profile-tall.svg" width="100%" alt="Animated full-height terminal profile and high-density character portrait for {garden.name}">
</p>
'''
